...
var paymentToast = app.toast.create({
	text: 'Payments is temporarily unavailable due to problems with the merchant, please use taskwall to get access. Sorry for the inconvenience.',
	closeTimeout: 5000,
	position: 'top',
});
function pay(){
